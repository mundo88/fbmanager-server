    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lock_screen_password', models.CharField(blank=True, default='', max_length=255)),
                ('theme', models.CharField(choices=[('system', 'System'), ('dark', 'Dark'), ('light', 'Light')], default='system', max_length=255)),
                ('primary_color', models.CharField(default='blue', max_length=255)),
